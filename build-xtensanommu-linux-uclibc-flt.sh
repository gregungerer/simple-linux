...
#
# build-xtensanommu-linux-uclibc-flt.sh -- build really simple nommu linux for XTENSA
#
...
#		-M lx60 -cpu dc233c \
#		-nographic \
#		-kernel linux-6.11/arch/xtensa/boot/Image.elf
#

CPU=xtensa
TARGET=xtensa-uclinux-uclibc
FLAVOR=xtensa-flt
